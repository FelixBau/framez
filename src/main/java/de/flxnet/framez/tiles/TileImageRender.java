...
import de.flxnet.framez.helpers.Pair;
...
public class TileImageRender {
	...
	private TileRenderPackage renderPackage;
	...
	public TileImageRender(BufferedImage image, boolean itemFramesVisible, TileDirection tileDirection) {
		this.id = TileStore.nextId();
		this.image = image;
		this.itemFramesVisible = itemFramesVisible;
		this.tileDirection = tileDirection;
	}
	
	public TileRenderPackage getRenderPackage(World world, BlockPosition blockPosition) {
		...
		renderPackage = new TileRenderPackage(world, blockPosition, getMapData(), entityPacketPair.getFirst(), entityPacketPair.getSecond());
	...
	private RenderData render() {
        ...
        TileMapCanvas canvas = new TileMapCanvas();
